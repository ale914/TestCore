    ...
    for (i = 0; i < nprops; i++) {
        switch (props[i]) {
            ...
            case 90:
               ...
               break;
            case 91:
               colour = FOREGROUND_INTENSITY | FOREGROUND_RED;
               break;
            case 92:
               colour = FOREGROUND_INTENSITY | FOREGROUND_GREEN;
               break;
            case 93:
               colour = FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_GREEN;
               break;
            case 94:
               colour = FOREGROUND_INTENSITY | FOREGROUND_BLUE;
               break;
            case 95:
               colour = FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_BLUE;
               break;
            case 96:
               colour = FOREGROUND_INTENSITY | FOREGROUND_BLUE | FOREGROUND_GREEN;
               break;
            case 97:
               colour = FOREGROUND_INTENSITY | FOREGROUND_RED | FOREGROUND_BLUE | FOREGROUND_GREEN;
               break;
        }
    }
